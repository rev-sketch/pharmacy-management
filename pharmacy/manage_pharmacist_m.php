    ...
    <div class="container-fluid">
      <div class="container">
        ...
        <?php
          ...
          createHeader('handshake', 'Manage pharmacist', 'Manage Existing pharmacist');
        ?>
        <!-- header section end -->
          ...
          <div class="col col-md-12 table-responsive">
            <div class="table-responsive">
            	<table class="table table-bordered table-striped table-hover">
                  ...
                  <th style="width: 10%;">Pharmacist ID</th>
                ...
                ?>
                    <tr>
                      <td><?php echo $rows['pharmacist_id'] ?></td>
                      ...
                      <!-- <td>
                        <button href="" class="btn btn-info btn-sm" onclick="editCustomer(<?php echo $rows['pharmacist_id']; ?>);">
                          <i class="fa fa-pencil"></i>
                        </button>
                        <button class="btn btn-danger btn-sm" onclick="deleteCustomer(<?php echo $rows['pharmacist_id']; ?>);">
