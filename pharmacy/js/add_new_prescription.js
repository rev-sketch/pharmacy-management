...
class PrescriptionInfo {
  constructor(name, batch_id, expiry_date, quantity, strength, dose) {
    this.name = name;
    this.batch_id = batch_id;
    this.expiry_date = expiry_date;
    this.quantity = quantity;
...
function addRow() {
  ...
  xhttp.open(
    "GET",
    "php/add_new_prescription.php?action=add_row&row_id=" +
      cls.value +
      "&row_number=" +
      addRow.counter,
    true
...
function getInvoiceNumber() {
  ...
  xhttp.onreadystatechange = function () {
    if ((xhttp.readyState = 4 && xhttp.status == 200))
      document.getElementById("prescription_number").value = xhttp.responseText;
  };
  xhttp.open(
    "GET",
    "php/add_new_prescription.php?action=current_prescription_number",
    true
  );
  xhttp.send();
}
...
function medicineOptions(text, id) {
  ...
  xhttp.open(
    "GET",
    "php/add_new_prescription.php?action=medicine_list&text=" + text.trim(),
    true
  );
  xhttp.send();
}
...
function fill(name, field_name, column) {
  ...
  xhttp.open(
    "GET",
    "php/add_new_prescription.php?action=fill&name=" +
      name +
      "&column=" +
      column,
    false
...
function checkAvailableQuantity(value, id) {
  ...
  xhttp.open(
    "GET",
    "php/add_new_prescription.php?action=check_quantity&medicine_name=" +
      medicine_name,
    false
  );
  xhttp.send();
...
function isCustomer(name, contact_number) {
  ...
  xhttp.open(
    "GET",
    "php/add_new_prescription.php?action=is_customer&name=" +
      name +
      "&contact_number=" +
      contact_number,
    false
...
function isInvoiceExist(invoice_number) {
  ...
  xhttp.open(
    "GET",
    "php/add_new_prescription.php?action=is_invoice&invoice_number=" +
      invoice_number,
    false
  );
  xhttp.send();
...
function isMedicine(name) {
  ...
  xhttp.open(
    "GET",
    "php/add_new_prescription.php?action=is_medicine&name=" + name,
    false
  );
  xhttp.send();
  //alert(xhttp.responseText);
...
function addInvoice() {
  ...
  var invoice_number = document.getElementById("prescription_number");
...
function updateStock(name, batch_id, quantity) {
  ...
  xhttp.open(
    "GET",
    "php/add_new_prescription.php?action=update_stock&name=" +
      name +
      "&batch_id=" +
      batch_id +
      "&quantity=" +
...
function addSale(
  ...
  xhttp.open(
    "GET",
    "php/add_new_prescription.php?action=add_sale&customers_name=" +
      customers_name +
      "&customers_contact_number=" +
      customers_contact_number +
      "&invoice_number=" +
...
function addNewInvoice(
  ...
  xhttp.open(
    "GET",
    "php/add_new_prescription.php?action=add_new_prescription&customers_name=" +
      customers_name +
      "&customers_contact_number=" +
      customers_contact_number +
      "&invoice_date=" +
