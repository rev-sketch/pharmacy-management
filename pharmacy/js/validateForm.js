...
//   alert("hiiiiiiiiii");
//   document.getElementById("pharmacist_acknowledgement").innerHTML = "";
...
//     fname.focus();
//   else if(!validateName(lname.value, "name_error"))
//     lname.focus();
//   else if(!validateContactNumber(phone.value, "contact_number_error"))
//     phone.focus();
//   else if(!validateAddress(address.value, 'doctor_address_error'))
//     address.focus();
...
//   			document.getElementById("pharmacist_acknowledgement").innerHTML = xhttp.responseText;
//   	};
//   	xhttp.open("GET", "php/add_new_pharmacist.php?fname=" + fname.value + "&lname=" + lname.value + "&phone=" + phone.value + "&address=" + address.value + "&staff_id=" + staff_id.value + "&email=" + email.value + "&username=" + username.value + "&password=" + password.value, true);
//   	xhttp.send();
//   }
//   return false;
// }
...
function addCustomer() {
  ...
  // 			document.getElementById("customer_acknowledgement").innerHTML = xhttp.responseText;
  // 	};
  // 	xhttp.open("GET", "php/add_new_manager.php?fname=" + fname.value + "&lname=" + lname.value + "&phone=" + phone.value + "&address=" + address.value + "&staff_id=" + staff_id.value + "&email=" + email.value + "&username=" + username.value + "&password=" + password.value, true);
  // 	xhttp.send();
  // }
  // return false;
}
