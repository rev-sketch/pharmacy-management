...
<html lang="en" dir="ltr">
  <head>
    ...
    <script src="js/add_new_prescription.js"></script>
    ...
    <div class="container-fluid">
      <div class="container">
        ...
        <?php
          ...
          createHeader('clipboard', 'New Prescription', 'Create New Prescription');
        ?>
        <!-- header section end -->
        ...
        <div class="row">
          ...
          <div class="row col col-md-12">
            ...
            <div class="col col-md-2 form-group">
              <label class="font-weight-bold" for="prescription_number">Prescription Number :</label>
              <input id="prescription_number" type="text" class="form-control" name="prescription_number" placeholder="Precription Number">
            </div>
            <!-- <div class="col col-md-2 form-group">
          ...
          <div class="row col col-md-12">
            <div class="row col col-md-12 font-weight-bold">
              ...
              <div class="col col-md-1">Strength</div>
              <div class="col col-md-1">Dose</div>
