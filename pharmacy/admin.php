      ...
      <div class="container">
        ...
        <div class="row">
          <div class="row col col-xs-8 col-sm-8 col-md-8 col-lg-8">
            ...
            <?php
              ...
              createSection1('manage_manager.php', 'Total Managers', 'manager');
              createSection1('manage_cashier.php', 'Total Cashiers', 'cashier');
              createSection1('manage_pharmacist.php', 'Total Pharmacists', 'pharmacist');
        ...
        <div class="row">
          ...
          <?php
            ...
            createSection2('address-card', 'add_manager.php', 'Add New Manager');
            createSection2('handshake', 'add_pharmacist.php', 'Add New Pharmacist');
            createSection2('shopping-bag', 'add_cashier.php', 'Add New Cashier');
