    ...
    <div class="container-fluid">
      <div class="container">
        ...
        <?php
          ...
          createHeader('handshake', 'Add Phamracist', 'Add New Phamracist');
          // header section end
        ?>
        <div class="row">
          <div class="row col col-md-6">
            <?php
              // form content
             // require "php/add_new_pharmacist.php";
            ?>
        <div class="container">

<div id="login-form" >
    <div class="card-body">
        <form name="login-form" class="login-form" action="php/add_new_pharmacist.php" method="post">
            </div>
