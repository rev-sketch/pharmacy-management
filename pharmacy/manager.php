...
<html lang="en" dir="ltr">
  ...
  <body>
    <?php include "sections/manager_sidenav.html"; ?>
      ...
      <div class="container">
        ...
        <div class="row">
          <div class="row col col-xs-8 col-sm-8 col-md-8 col-lg-8">
            ...
            <?php
              ...
              // createSection1('manage_customer.php', 'Total Managers', 'manager');
              createSection1('manage_supplier.php', 'Total Supplier', 'suppliers');
              createSection1('manage_medicine_m.php', 'Total Medicine', 'medicines');
              createSection1('manage_medicine_stock_m.php?out_of_stock', 'Out of Stock', 'medicines_stock');
              createSection1('manage_medicine_stock_m.php?expired', 'Expired', 'medicines_stock');
        ...
        <div class="row">
          ...
          <?php
            ...
            createSection2('shopping-bag', 'add_medicine_m.php', 'Add New Medicine');
