    ...
    <div class="container-fluid">
      <div class="container">
        ...
        <?php
          ...
          createHeader('handshake', 'Manage Manager', 'Manage Existing Manager');
        ?>
        <!-- header section end -->
            ...
            <div class="table-responsive">
                ...
                ?>
                    <tr>
                      ...
                      <td>
                      <form style="display: inline-block;" method="post" action="delete_manager.php">
                          <input type="hidden" name="manager_id" value="<?php echo $rows['manager_id'] ?>">
